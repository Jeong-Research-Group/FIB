...
Detailed information on each screening stage and the corresponding intermediate structures is provided in [`alex-mp-20/README.txt`](alex-mp-20/README.txt) and [`mp-F/README.md`](mp-F/README.md).
